...
class Trainer():
    ...
    def train(self):
        ...
        for batch, (lr, hr, _,) in enumerate(self.loader_train):
            ...
            pred_max_p = torch.nn.functional.max_pool2d(sr, kernel_size=3, stride=1)
            pred_min_p = torch.nn.functional.max_pool2d(-sr, kernel_size=3, stride=1)

            loss = self.loss(sr, hr)\
                 + torch.nn.L1Loss()(pred_max_p, hr_max_p)\
                      + torch.nn.L1Loss()(pred_min_p, hr_min_p)
